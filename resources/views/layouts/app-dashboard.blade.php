...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <script src="{{ asset('js/tinymce-5/tinymce.min.js') }}"></script>
  ...
  <script>
                ...
                console.log(data);
                  ...
                  if (data.location) {
                    ...
                    //   editor.insertContent('<img src="' + data.location + '" />');
                      console.log('Upload success with URL:', data.location);
                  } else {
    ...
    .catch(error => {
        ...
        if (typeof failure === 'function') failure('HTTP Error: ' + error.message);
    });
          },
