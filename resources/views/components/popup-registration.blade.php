        ...
        <div class="row justify-center">
          ...
          <div class="col-md-12">
            <form method="POST" enctype="multipart/form-data" id="myForm">
              ...
              <!-- Date -->
              <div class="mb-2 lg:mb-4">
                <x-text-input id="datepicker" class="block mt-1 w-full font-owners_trial_wide_medium datepicker" type="text" name="born_date" :value="old('born_date')" required autofocus autocomplete="born_date" placeholder="Born Date (ex: 2000-01-01)"/>
              ...
              <!-- Instagram -->
              <div class="mb-2 lg:mb-4">
                <x-text-input id="instagram" class="block mt-1 w-full font-owners_trial_wide_medium" type="text" name="instagram" :value="old('instagram')" autofocus autocomplete="instagram" placeholder="Instagram" />
              ...
              <!-- Community Name -->
              <div class="mb-2 lg:mb-4">
                <x-text-input id="community_name" class="block mt-1 w-full font-owners_trial_wide_medium" type="text" name="community_name" :value="old('community_name')" autofocus autocomplete="community_name" placeholder="Community Name" />
                <x-input-error :messages="$errors->get('community_name')" class="mt-2" />
              </div>

              <!-- Group -->
              <div class="mb-2 lg:mb-4">
                <select name="group" id="" class="text-[14px] border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full font-owners_trial_wide_medium" required placeholder="Choose interest">
                    <option value="" selected>Choose interest</option>
              ...
              <!-- <div class="mb-2 lg:mb-4">
                <div class="relative w-full border-2 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                  <input type="file" name="profile_pic" class="relative w-100 z-3 opacity-0 py-[20px] px-3" id="fileInput">
                ...
                <div id="preview-text-container" class="relative flex justify-between align-items-center overflow-hidden mt-2 px-3 py-1 bg-[#efefef] rounded-md" hidden>
                  <p id="fileName"></p>
                  <button type="button" class="remove" aria-label="Remove" id="removeBtn">
              ...
              <div class="mb-2 lg:mb-4">
                <div class="relative w-full border-2 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                  <input type="file" name="profile_pic" class="relative w-100 z-3 opacity-0 py-[20px] px-3" id="fileInput">
                  <div class="absolute flex top-[20px] left-[2px] py-0 px-[10px] lg:p-[10px] bg-primary-white">
                    <img src="{{asset('/images/icon-upload.png')}}" alt="" class="w-[26px] h-auto object-contain mr-3">
                    <p class="text-gray-400 font-owners_trial_wide_medium">Upload profile picture</p>
                  </div>
                </div>
